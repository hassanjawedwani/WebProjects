...
const NewsLetter = () => {
  return (
    <div>
      <h2 className='text-center text-2xl md:text-4xl font-medium text-slate-700 mb-1 lg:mb-4'>Never Miss a Deal!</h2>
      ...
      <div className='h-12 w-full border border-gray-300 rounded-md flex bg-primary px-1.5  max-w-2xl mx-auto'>
